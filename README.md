...
Product screenshots are included in the [`Screenshots/`](./Screenshots) folder:

![Login screen](./Screenshots/1.png)
![Buyer dashboard](./Screenshots/2.png)
![Property discovery](./Screenshots/3.png)

The remaining numbered images in that folder capture the other buyer, seller, listing, and interest-management views.
